        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="p-5 bg-white rounded-2xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Akun aktif terdaftar</p>
                </div>
                <div class="w-12 h-12 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 flex items-center justify-center">
            ...
            <div class="p-5 bg-white rounded-2xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-purple-600 dark:text-purple-400 uppercase tracking-wider">Administrator</p>
                    <h3 class="text-2xl font-bold text-purple-700 dark:text-purple-300 mt-1">{{ $totalAdmin }}</h3>
            ...
            <div class="p-5 bg-white rounded-2xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-blue-600 dark:text-blue-400 uppercase tracking-wider">Manajer Gudang</p>
                    <h3 class="text-2xl font-bold text-blue-700 dark:text-blue-300 mt-1">{{ $totalManager }}</h3>
                    <p class="text-xs text-gray-500 mt-1">Operasional & Laporan</p>
                </div>
            ...
            <div class="p-5 bg-white rounded-2xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">Staff Gudang</p>
                    <h3 class="text-2xl font-bold text-emerald-700 dark:text-emerald-300 mt-1">{{ $totalStaff }}</h3>
                    <p class="text-xs text-gray-500 mt-1">Eksekusi fisik lapangan</p>
                </div>
